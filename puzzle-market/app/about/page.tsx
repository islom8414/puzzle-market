  ...
  return (
    <main className="min-h-screen bg-black text-white px-4 md:px-6 py-12 overflow-hidden">
      <section className="mx-auto max-w-7xl">
        <p className="text-cyan-400 text-xs font-black uppercase tracking-[0.18em] md:tracking-[0.3em]">
          About Puzzle Market
        </p>

        <h1 className="translate-safe-title mt-5 max-w-5xl font-black">
          Hidden puzzle pieces with real ownership.
        </h1>

        <p className="translate-safe-copy mt-7 max-w-3xl text-lg text-zinc-400">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 xl:grid-cols-3">
          {[
            ...
            <div
              key={title}
              className="min-w-0 rounded-[28px] border border-white/10 bg-white/[0.03] p-7"
            >
              <h2 className="translate-safe-heading text-2xl md:text-3xl font-black">
                {title}
              </h2>

              <p className="translate-safe-copy mt-5 text-zinc-400">
                {body}
              </p>
            </div>
          ))}
        ...
        <div className="mt-10 rounded-[32px] border border-cyan-400/20 bg-cyan-400/[0.04] p-8">
          <h2 className="translate-safe-heading text-3xl font-black">
            Privacy First
          </h2>

          <p className="translate-safe-copy mt-4 max-w-3xl text-zinc-400">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link
            href="/"
            className="translate-safe-action rounded-2xl bg-cyan-400 px-7 py-4 font-black text-black transition hover:bg-cyan-300"
          >
            Choose Puzzle
          </Link>
          ...
          <Link
            href="/marketplace"
            className="translate-safe-action rounded-2xl border border-white/10 bg-white/5 px-7 py-4 font-black transition hover:border-cyan-400"
          >
            Open Marketplace
          </Link>
        </div>
